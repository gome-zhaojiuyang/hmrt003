...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/hmrtgroupchat/hmrtGroupChat/">分组聊天列表</a></li>
		<li class="active"><a href="${ctx}/hmrtgroupchat/hmrtGroupChat/form?id=${hmrtGroupChat.id}">分组聊天<shiro:hasPermission name="hmrtgroupchat:hmrtGroupChat:edit">${not empty hmrtGroupChat.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="hmrtgroupchat:hmrtGroupChat:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
